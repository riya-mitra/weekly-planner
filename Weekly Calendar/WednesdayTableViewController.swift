//
//  WednesdayTableViewController.swift
//  Weekly Calendar
//
...
class WednesdayTableViewController: UITableViewController {
    
    let swiftyData = CoreDataModule(entityName: "Wednesday", xcDataModelID: "Model")
