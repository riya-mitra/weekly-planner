//
//  ThursdayTableViewController.swift
//  Weekly Calendar
//
...
class ThursdayTableViewController: UITableViewController {
    
    let swiftyData = CoreDataModule(entityName: "Thursday", xcDataModelID: "Model")
