//
//  TuesdayTableViewController.swift
//  Weekly Calendar
//
...
class TuesdayTableViewController: UITableViewController {
    
    let swiftyData = CoreDataModule(entityName: "Tuesday", xcDataModelID: "Model")
